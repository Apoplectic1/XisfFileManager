...
- [x] 3.2 Manual: checked browse of raw lights → all solve; save; re-browse the saved set → all
      skip (no solver processes, status shows skipped count); unchecked browse → no solver
      involvement; a mixed directory reports solved + skipped correctly (field-verified 2026-08-06)
